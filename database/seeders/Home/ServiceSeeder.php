...
class ServiceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $services = [
            [
                'name' => [
                    'id' => 'Strategi Digital & Discovery',
                    'en' => 'Digital Strategy & Discovery',
                ],
                'description' => [
                    'id' => 'Kami bekerja bersama Anda untuk memahami kebutuhan bisnis dan menyusun roadmap produk yang realistis serta terukur.',
                    'en' => 'We work together with you to understand business needs and develop a realistic and measurable product roadmap.',
                ],
            ...
            [
                'name' => [
                    'id' => 'Desain Experience & Branding',
                    'en' => 'Experience Design & Branding',
                ],
                'description' => [
                    'id' => 'Tim UI/UX kami membangun tampilan yang elegan dan mudah digunakan, lengkap dengan guideline merek yang konsisten di semua saluran.',
                    'en' => 'Our UI/UX team builds elegant and user-friendly interfaces, complete with consistent brand guidelines across all channels.',
                ],
            ...
            [
                'name' => [
                    'id' => 'Pengembangan Produk End-to-End',
                    'en' => 'End-to-End Product Development',
                ],
                'description' => [
                    'id' => 'Kami membangun aplikasi web maupun mobile yang skalabel dengan praktik engineering modern, CI/CD, dan pengujian menyeluruh.',
                    'en' => 'We build scalable web and mobile applications with modern engineering practices, CI/CD, and comprehensive testing.',
                ],
            ...
            [
                'name' => [
                    'id' => 'Optimalisasi & Growth Marketing',
                    'en' => 'Optimization & Growth Marketing',
                ],
                'description' => [
                    'id' => 'Kami mendukung peluncuran dan pengembangan produk melalui analitik, eksperimen, dan kampanye digital yang terukur.',
                    'en' => 'We support product launches and growth through analytics, experiments, and measurable digital campaigns.',
                ],
        ...
        foreach ($services as $serviceData) {
            $baseName = $serviceData['name']['id'] ?? reset($serviceData['name']);
            $slug = Str::slug($baseName);
            $service = Service::where('slug', $slug)->first();

            $serviceData['slug'] = $serviceData['slug'] ?? $slug;
