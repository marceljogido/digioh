...
<?php $__env->startSection("content"); ?>
    ...
    <section id="services" class="bg-white dark:bg-slate-950">
        <div class="mx-auto max-w-screen-xl px-4 py-16 text-center sm:px-12">
            <span data-aos="fade-down" class="text-xs font-semibold uppercase tracking-[0.3em] text-[#f17720]"><?php echo e(__('Our Services')); ?></span>
            <h2 data-aos="fade-up" data-aos-delay="100" class="mt-3 text-3xl font-bold text-[#11224e] dark:text-white"><?php echo e(__('Layanan yang kami tawarkan')); ?></h2>
            <p data-aos="fade-up" data-aos-delay="200" class="mx-auto mt-4 max-w-3xl text-sm text-slate-600 dark:text-slate-100"><?php echo e(__('We help companies design, build, and grow end-to-end digital products.')); ?></p>
            ...
            <div class="mt-12 grid gap-10 md:grid-cols-2 xl:grid-cols-4">
                <?php $__currentLoopData = $services->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article data-aos="fade-up" data-aos-delay="<?php echo e(100 + ($index * 100)); ?>" class="flex h-full flex-col items-center text-center gap-4 rounded-3xl border border-[#e9e6df] bg-white p-6 shadow-sm hover-lift dark:border-slate-800/60 dark:bg-slate-900 dark:shadow-black/40">
                        ...
                        <div class="h-28 w-28 rounded-full border-4 border-[#ffa630] bg-white p-1 shadow-lg shadow-[#ffa630]/30">
                            <div class="h-full w-full overflow-hidden rounded-full">
                                <?php if($imagePath): ?>
                                    <img src="<?php echo e(asset($imagePath)); ?>" alt="<?php echo e($service['title']); ?>" class="h-full w-full object-cover">
                        ...
                        <h3 class="text-lg font-bold text-[#11224e] dark:text-white"><?php echo e($service['title']); ?></h3>
                        <p class="text-sm text-slate-600 dark:text-slate-100"><?php echo e($service['description']); ?></p>
                        <?php if(!empty($service['slug'])): ?>
                            <a href="<?php echo e(route('frontend.services.show', $service['slug'])); ?>" class="mt-auto inline-flex items-center gap-2 text-sm font-semibold text-indigo-600 hover:text-[#f17720] dark:text-[#ffa630]">
                                <?php echo e(__('Pelajari layanan ini')); ?>
...
<?php echo $__env->make("frontend.layouts.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/digioh/resources/views/frontend/index.blade.php ENDPATH**/ ?>