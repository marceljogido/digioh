<footer class="relative overflow-hidden bg-gradient-to-b from-[#5c83c4] via-[#4f6da9] to-[#11224e] text-white/80">
    ...
    <div class="relative mx-auto max-w-screen-xl px-4 py-10 sm:px-10">
        <div class="grid gap-8 lg:grid-cols-[1.2fr_0.8fr_0.8fr]">
            <div class="space-y-4">
                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3 text-xl font-semibold">
                    <img src="<?php echo e(asset('/img/DIGIOH_Main Logo_Flat Color White.svg')); ?>" alt="<?php echo e(app_name()); ?>" class="h-10 w-auto" />
                </a>
                <p class="text-xs leading-relaxed text-white/70">
                    <?php echo (app()->getLocale() == 'en' && setting('app_description_en')) ? setting('app_description_en') : setting('meta_description'); ?>
                ...
                <div class="space-y-2 text-sm text-white/85">
                    <div class="flex items-center gap-4">
                        ...
                        <a href="mailto:<?php echo e(setting('contact_email') ?? $defaultContactEmail); ?>" class="hover:text-white"><?php echo e(setting('contact_email') ?? $defaultContactEmail); ?></a>
                    </div>
                    <div class="flex items-start gap-4">
                        ...
                        <span class="leading-relaxed"><?php echo nl2br(e((app()->getLocale() == 'en' && setting('contact_address_en')) ? setting('contact_address_en') : (setting('contact_address') ?? $defaultContactAddress))); ?></span>
                    </div>
                </div>
                <div class="pt-1">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.social.all-social-url','data' => ['class' => 'flex flex-wrap gap-2 [&>a]:text-white/70 [&>a]:text-sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'flex flex-wrap gap-2 [&>a]:text-white/70 [&>a]:text-sm']); ?>
...
<?php endif; ?>
            ...
            <div class="space-y-4 text-sm">
                <p class="text-xs font-semibold uppercase tracking-[0.3em] text-white/70"><?php echo e(__('Menu & Resources')); ?></p>
                <ul class="grid gap-3 text-white/70 sm:grid-cols-2">
                    <li><a href="<?php echo e(route('home')); ?>" class="transition hover:text-white"><?php echo e(__('Beranda')); ?></a></li>
                    <li><a href="<?php echo e(route('frontend.ourwork.index')); ?>" class="transition hover:text-white"><?php echo e(__('Our Work')); ?></a></li>
                    <li><a href="<?php echo e(route('frontend.services.index')); ?>" class="transition hover:text-white"><?php echo e(__('Layanan kami')); ?></a></li>
                    <li><a href="<?php echo e(route('about')); ?>" class="transition hover:text-white"><?php echo e(__('Tentang Digioh')); ?></a></li>
                    ...
                    <li><a href="<?php echo e($__waLink); ?>" target="_blank" rel="noopener" class="transition hover:text-white"><?php echo e(__('Hubungi kami')); ?></a></li>
                    <li><a href="<?php echo e(url('/#faq')); ?>" class="transition hover:text-white"><?php echo e(__('FAQ')); ?></a></li>
            ...
            <div class="space-y-3 text-sm">
                <p class="text-xs font-semibold uppercase tracking-[0.3em] text-white/70"><?php echo e(__('Visit Our Location')); ?></p>
                ...
                <?php else: ?>
                    <p class="text-white/70"><?php echo e(setting('contact_address') ?? $defaultContactAddress); ?></p>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="mt-10 flex flex-col gap-3 border-t border-white/10 pt-4 text-xs text-white/60 sm:flex-row sm:items-center sm:justify-between">
            <p>© <?php echo e(date('Y')); ?> digiOH. All Rights Reserved.</p>
            <div class="flex flex-wrap items-center gap-4"></div>
        </div>
    </div>
</footer>
<?php /**PATH C:\Users\Marcel\Music\3.digioh\resources\views/frontend/includes/footer.blade.php ENDPATH**/ ?>