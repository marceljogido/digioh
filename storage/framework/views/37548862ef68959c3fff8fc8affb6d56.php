...
<?php endif; ?>
            ...
            <div class="row mt-4">
                <div class="col">
                    ...
                    <?php echo e(html()->hidden('active_section', 'about')); ?>
...
<?php endif; ?>
                            <a href="<?php echo e(route("backend.$module_name.index")); ?>" class="btn btn-secondary ms-2">
...
<?php echo $__env->make('backend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Marcel\Music\3.digioh\resources\views/backend/settings/about.blade.php ENDPATH**/ ?>