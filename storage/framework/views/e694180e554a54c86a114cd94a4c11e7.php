    ...
    <div class="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-4">
        ...
        <div class="flex items-center justify-end space-x-1 md:order-2 md:space-x-0 rtl:space-x-reverse">
            <div class="hidden items-center gap-1 pe-2 md:flex">
                <?php $__currentLoopData = ['id' => 'ID', 'en' => 'EN']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $localeCode => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a
                        href="<?php echo e(route('language.switch', $localeCode)); ?>"
                        class="rounded-full border px-3 py-1 text-xs font-semibold transition <?php echo e($currentLocale === $localeCode ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white/10 text-slate-600 hover:text-slate-900 dark:text-slate-200 dark:hover:text-white border-white/30'); ?>"
                    >
                        <?php echo e($label); ?>
            ...
            <?php if(auth()->guard()->check()): ?>
                ...
                >
                    ...
                    <span class="ms-2 hidden sm:block">
                        <?php echo e(Str::limit(Auth::user()->name, 18)); ?>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginal60ba81ad315c3ebabe40526fbfddb04f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal60ba81ad315c3ebabe40526fbfddb04f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.nav-item','data' => ['href' => route('about'),'active' => request()->routeIs('about')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('frontend.nav-item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginal60ba81ad315c3ebabe40526fbfddb04f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal60ba81ad315c3ebabe40526fbfddb04f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.nav-item','data' => ['href' => route('frontend.ourwork.index'),'active' => request()->routeIs('frontend.ourwork.*')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('frontend.nav-item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('frontend.ourwork.index')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('frontend.ourwork.*'))]); ?>
                    <?php echo e(__("Our Work")); ?>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginal60ba81ad315c3ebabe40526fbfddb04f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal60ba81ad315c3ebabe40526fbfddb04f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.nav-item','data' => ['href' => route('frontend.services.index'),'active' => request()->routeIs('frontend.services.*')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('frontend.nav-item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('frontend.services.index')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('frontend.services.*'))]); ?>
                    <?php echo e(__('Layanan')); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginal60ba81ad315c3ebabe40526fbfddb04f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal60ba81ad315c3ebabe40526fbfddb04f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.nav-item','data' => ['href' => route('contact'),'active' => request()->routeIs('contact')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('frontend.nav-item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                <li class="flex items-center gap-2 md:hidden">
                    <?php $__currentLoopData = ['id' => 'Bahasa', 'en' => 'English']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $localeCode => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a
                            href="<?php echo e(route('language.switch', $localeCode)); ?>"
                            class="rounded-full border px-3 py-1 text-xs font-semibold transition <?php echo e($currentLocale === $localeCode ? 'bg-indigo-600 text-white border-indigo-600' : 'text-slate-600 hover:text-slate-900 dark:text-slate-200 dark:hover:text-white border-slate-200 dark:border-slate-700'); ?>"
                        >
                            <?php echo e($label); ?>
...
<?php /**PATH C:\Users\Marcel\Music\3.digioh\resources\views/frontend/includes/header.blade.php ENDPATH**/ ?>