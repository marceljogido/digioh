        ...
        <div class="grid gap-10 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
            <div>
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-xs font-semibold uppercase tracking-[0.35em] text-slate-500"><?php echo e($locale === 'en' ? 'About us' : 'Tentang kami'); ?></span>
                </div>
                ...
                <div class="mt-8 flex flex-wrap items-center gap-4">
                    <a href="<?php echo e(route('about')); ?>" class="inline-flex items-center justify-center rounded-full bg-indigo-600 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-indigo-500/30 hover:bg-indigo-500">
                        <?php echo e($locale === 'en' ? 'Learn more about us' : 'Pelajari selengkapnya'); ?>

                    </a>
                    <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center gap-2 text-sm font-semibold text-slate-900 hover:text-slate-700 dark:text-indigo-200 dark:hover:text-white">
            ...
            <div class="relative hidden lg:block">
                ...
                <div class="relative overflow-hidden rounded-[2.5rem] border border-slate-100 shadow-xl dark:border-slate-800/60">
                    <?php if(setting('about_image')): ?>
                        <img class="h-full w-full object-cover" src="<?php echo e(asset(setting('about_image'))); ?>" alt="<?php echo e($aboutTitle ?: 'Digioh'); ?>">
                    <?php else: ?>
...
<?php /**PATH /var/www/digioh/resources/views/frontend/pages/partials/about-snippet.blade.php ENDPATH**/ ?>