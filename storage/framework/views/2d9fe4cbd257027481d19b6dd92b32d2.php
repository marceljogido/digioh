                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <?php echo app('translator')->get("clientlogo::text.name"); ?>
                            </th>
                            <th>
                                <?php echo app('translator')->get("clientlogo::text.updated_at"); ?>
                            </th>
                            <th class="text-end">
                                <?php echo app('translator')->get("clientlogo::text.action"); ?>
                            </th>
                        </tr>
                    </thead>
                </table>
...
<script type="module">
    $('#datatable').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: '<?php echo e(route("backend.clientlogos.index_data")); ?>',
        order: [],
        columns: [{
                data: 'DT_RowIndex',
                name: 'DT_RowIndex',
...
<?php echo $__env->make('backend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Marcel\Music\3.digioh\Modules/ClientLogo/Resources/views/backend/clientlogos/index_datatable.blade.php ENDPATH**/ ?>