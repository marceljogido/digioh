                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th class="text-end">
                                <?php echo app('translator')->get("slider::text.action"); ?>
                            </th>
                        </tr>
                    </thead>
                </table>
...
<?php echo $__env->make('backend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Marcel\Music\3.digioh\Modules/Slider/Resources/views/backend/sliders/index_datatable.blade.php ENDPATH**/ ?>