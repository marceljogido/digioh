...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | These lines contain the default error messages used by the validator.
    ...
    */
    ...
    'required_without_all' => 'Kolom :attribute wajib diisi ketika tidak ada satu pun dari :values yang hadir.',
    ...
    |--------------------------------------------------------------------------
    |
    | Specify custom validation messages for attributes using the convention
    | "attribute.rule".
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Replace attribute placeholders with something more readable, e.g.
    | "E-Mail Address" instead of "email".
    |
    */
