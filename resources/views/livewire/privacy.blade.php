    ...
    <section class="mx-auto max-w-screen-xl bg-white p-6 text-gray-600 sm:p-20">
        <div class="grid grid-cols-1 text-justify">
            @if(app()->getLocale() === 'id')
                {{-- BAHASA INDONESIA --}}
                <p>
                    Di {{ app_name() }}, yang dapat diakses di
                    ...
                    informasi yang dikumpulkan dan dicatat oleh {{ app_name() }} dan bagaimana kami menggunakannya.
                </p>
                <p>
                    Jika Anda memiliki pertanyaan tambahan atau memerlukan informasi lebih lanjut tentang Kebijakan Privasi kami,
                    jangan ragu untuk menghubungi kami melalui email di {{ $app_email }}
                </p>
                <p>
                    Kebijakan privasi ini hanya berlaku untuk aktivitas online kami dan berlaku untuk pengunjung website kami
                    terkait informasi yang mereka bagikan dan/atau kumpulkan di {{ app_name() }}. Kebijakan ini tidak berlaku
                ...
                <p>
                    {{ app_name() }} mengikuti prosedur standar menggunakan file log. File-file ini mencatat pengunjung saat
                ...
                <p>
                    Seperti website lainnya, {{ app_name() }} menggunakan 'cookie'. Cookie ini digunakan untuk menyimpan informasi
                ...
                <p>
                    ...
                    Web Beacon yang digunakan dalam iklan dan tautan masing-masing yang muncul di {{ app_name() }}, yang
                    dikirim langsung ke browser pengguna. Mereka secara otomatis menerima alamat IP Anda saat ini terjadi.
                </p>
                <p>
                    Perhatikan bahwa {{ app_name() }} tidak memiliki akses ke atau kontrol atas cookie yang digunakan oleh
                    pengiklan pihak ketiga.
                </p>

                <h3 class="mb-2 mt-4 text-2xl">Kebijakan Privasi Pihak Ketiga</h3>
                <p>
                    Kebijakan Privasi {{ app_name() }} tidak berlaku untuk pengiklan atau website lain. Dengan demikian, kami
                ...
                <p>
                    {{ app_name() }} tidak dengan sengaja mengumpulkan Informasi Identifikasi Pribadi dari anak-anak di bawah usia 13 tahun.
