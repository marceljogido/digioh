    ...
    <section class="mx-auto max-w-screen-xl bg-white p-6 text-gray-600 sm:p-20">
        <div class="grid grid-cols-1">
            @if(app()->getLocale() === 'id')
                ...
                <p>
                    Syarat dan ketentuan ini mengatur aturan dan regulasi penggunaan Website {{ $company_name }}, yang berlokasi di
                ...
                <p>
                    ...
                    {{ app_name() }} jika Anda tidak setuju dengan seluruh syarat dan ketentuan yang tercantum di halaman ini.
                </p>
                <p>
                ...
                <p>
                    Kami menggunakan cookie di website ini. Dengan mengakses {{ app_name() }}, Anda setuju untuk menggunakan cookie
                    sesuai dengan Kebijakan Privasi {{ $company_name }}.
                </p>
                <p>
                ...
                <p>
                    Kecuali dinyatakan lain, {{ $company_name }} dan/atau pemberi lisensinya memiliki hak kekayaan intelektual untuk
                    semua materi di {{ app_name() }}. Semua hak kekayaan intelektual dilindungi. Anda dapat mengakses ini dari
                    {{ app_name() }} untuk penggunaan pribadi Anda sendiri dengan batasan yang ditetapkan dalam syarat dan ketentuan ini.
                </p>

                <h3 class="mb-2 mt-4 text-2xl">Anda tidak boleh:</h3>
                <ul class="list-inside list-disc">
                    <li>Mempublikasikan ulang materi dari {{ app_name() }}</li>
                    <li>Menjual, menyewakan atau mensublisensikan materi dari {{ app_name() }}</li>
                    <li>Mereproduksi, menduplikasi atau menyalin materi dari {{ app_name() }}</li>
                    <li>Mendistribusikan ulang konten dari {{ app_name() }}</li>
                </ul>
                ...
                <p>
                    ...
                    {{ $company_name }} tidak menyaring, mengedit, mempublikasikan atau meninjau Komentar sebelum kehadirannya di website.
                    Komentar tidak mencerminkan pandangan dan pendapat {{ $company_name }}, agen dan/atau afiliasinya.
                </p>
                <p>
                    {{ $company_name }} berhak untuk memantau semua Komentar dan menghapus Komentar yang dianggap tidak pantas,
            ...
            @else
                ...
                <p>
                    ...
                    {{ $company_name }}, its agents and/or affiliates.
                </p>
                <p>
