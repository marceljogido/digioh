        ...
        <div class="grid gap-16 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
            <div data-aos="fade-right">
                <div class="flex items-center gap-4">
                    ...
                    <span class="text-xs font-bold uppercase tracking-[0.4em] text-[#f17720] dark:text-[#ffa630]">{{ $locale === 'en' ? 'Who We Are' : 'Tentang Kami' }}</span>
                </div>
                ...
                <div class="mt-12 flex flex-wrap items-center gap-6">
                    ...
                    <a href="{{ route('contact') }}" class="group flex items-center gap-3 text-sm font-bold text-[#11224e] transition-colors hover:text-[#f17720] dark:text-indigo-200 dark:hover:text-[#ffa630]">
                ...
                >
                    <div class="relative overflow-hidden img-squircle border-8 border-white bg-white shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] dark:border-slate-800 dark:bg-slate-900 tilt-content">
                        @if(setting('about_image'))
                            <img class="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" src="{{ asset(setting('about_image')) }}" alt="{{ $aboutTitle ?: 'Digioh' }}">
                        @else
