            ...
            <div class="w-full max-w-md space-y-8">
                <div class="text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-600">
                        {{ __('Reset instructions sent to your email') }}
                    </p>
                </div>
                ...
                <div class="mt-8 rounded-lg bg-white p-8 shadow-xl">
                    <div class="text-center">
                        ...
                        <div class="mb-6 rounded-lg bg-blue-50 p-4 text-center">
                            ...
                            <h3 class="mt-4 text-lg font-medium text-gray-900">{{ __('Contact Administrator') }}</h3>
                            <p class="mt-2 text-sm text-gray-600">
                                {{ __("If you've forgotten your password, please contact your system administrator to reset it.") }}
                            </p>
                        </div>
